...
<div class="cruiscontainer">
    <div class="cruissliderbox"
        <?php
        if($cruis->TV['kr_slider_img_1']=='') echo 'style="display:none"';
        ?>
        >
                    ...
                    <?php
                        for($i=1;$i<4;$i++)
                        {
                            ...
                            <a href="#" class="w-lightbox w-inline-block">
                                <img src="<?php echo tmbImg( $cruis->TV['kr_slider_img_'.$i],'&w=700&zc=1'); ?>" class="cruissliderimg">
                                <script type="application/json" class="w-json">{
                                        "items": [
                                            {
                                                "url": "<?php  echo $cruis->TV['kr_slider_img_'.$i]; ?>",
                                                "fileName": "11.jpg",
                                                "origFileName": "1.jpg",
                                                "width": 472,
                                                "height": 473,
        ...
        <div data-animation="slide" data-duration="500" data-infinite="1"
            ...
            <div class="w-slider-mask">
                ...
                <div class="w-slide cruisslderslidemobile">
                        <img src="<?php echo tmbImg( $cruis->TV['kr_slider_img_'.$i],'&w=700&zc=1'); ?>" class="crsmobsliderimg">
                </div>
                        <?php
                    }
                    ?>
    ...
    <div class="bronDescription">
        <div class="bronShipTitle"><?php  echo $ship->title; ?></div>
        ...
        <?php echo $cruis->TV['pop_description']; ?>
        </div>
    </div>
    <h1 class="cruish2">Выберите каюту</h1>
...
<div class="w-clearfix cruistableitem">
            <div class="cruistablecol">
                <div class="cruischk click cauta-select"
...
?>
    ...
    <div class="cruisbronform" id="BronForm">
        <h3 style="width: " class="cruisformh3">Бронирование и оплата</h3>
        <div class="loader bronLoader">
        ...
        <form id="apex" style="display: none">
        ...
        <div class="w-form cruisinputform">
            <form id="z-form" name="z-form">
                ...
                <input type="hidden" id="cruis_inner_id" name="cruis_inner_id" value="<?php echo $cruis->TV['kr_inner_id']; ?>">
                <input type="hidden" id="cruis_id" name="cruis_id" value="<?php echo $cruis->id; ?>">
                <input type="hidden" id="curuis_price" name="cruis_id" value="<?php echo $cruis->id; ?>">
                <input type="hidden" id="ship_id" name="ship_id" value="<?php echo $cruis->parent; ?>">
                <input type="hidden" id="ship_name" name="ship_name" value="<?php echo $ship->title; ?>">
                <input type="hidden" id="action" name="action" value="z_add">

                <div class="cruisformleft">
                    <label for="FirstName" class="cruisformlabel">Ваше имя:</label>
                    <input id="FirstName" type="text" placeholder="например Иван" name="FirstName" required="required"
                        class="w-input cruisforminput">


                    <label for="LastName" class="cruisformlabel">Ваша фамилия:</label>
                    <input id="name" type="text" placeholder="например Иванов" name="LastName" required="required"
                           class="w-input cruisforminput">
<!--
                    <label for="birthday" class="cruisformlabel">Дата рождения:</label>
                    <input id="birthday" type="text" placeholder="" name="birthday" required="required"
                           class="w-input cruisforminput date_picker">-->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="cruisformcommitbutton pay"
                                style=" padding-top: 0;"
                                data-dismiss="modal"  onclick="Bron.OrderBy();">Закрыть</button>
        ...
        <div class="PayButtons">
            <div class="cruisformcommitbutton pay"  onclick="Bron.OrderBy();">Купить сейчас</div>
            <div class="cruisformcommitbutton"  onclick="Bron.Order();">Забронировать</div>
        </div>
    </div>
</div>